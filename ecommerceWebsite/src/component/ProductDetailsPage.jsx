        ...
        <Fade cascade>
          <div className="flex flex-col gap-5">
            ...
            <div className="flex gap-3">
              {sizeAvailable.map((size, id) => {
                return (
                  <div
                    key={id}
                    className="bg-[#C7C8CC] flex items-center justify-center h-[40px] w-[40px] rounded-full border-[1px] border-[#383838] "
                  >
          ...
          <div className="flex items-center justify-evenly">
            <button className="text-black font-medium border-[2px] border-[#383838] bg-[#C7C8CC] rounded-full w-32 h-20 text-4xl">
              BUY
            </button>
            <button className="text-black font-medium border-[2px] border-[#383838] bg-[#C7C8CC] rounded-full w-32 h-20 text-4xl">
              CART
